Feature: Create a Project and Category Relationship
    ...
    Scenario: User creates a relationship between Project and Category (Normal Flow)
        Given a Project with title "Test Project", completed "False", active "False", and a Category with title "ctest" exists in the system
    ...
    Scenario: User creates a relationship that already exists (Alternate Flow)
        Given a relationship between a Project with title "Test Project", completed "False", active "False", and a Category with title "ctest" alrady exists in the system
        When the user creates a relationship between the Project and category
        Then the relationship between the Project and Category is successfully created
